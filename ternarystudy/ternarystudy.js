...
(examGrade <=49 && examGrade>=1) ? `FF ${SAD}`:
"notu 1-100 arası girin"
info.classList.add("text-danger");

if (examGrade <=50 && examGrade <=100) {
